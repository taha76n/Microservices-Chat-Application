  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { data } = await axios.post(
        "http://localhost:5301/api/v1/user/verify",
        {
          email,
          otp: otpString,
        }
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-lg p-8">
          <div className="text-center mb-8">
            ...
            <form onSubmit={handleSubmit} action="" className="space-y-6">
              <div className=" mt-7">
                <label
                  className="text-gray-300 font-medium text-sm text-center"
                  htmlFor="email"
                >
            ...
            <div className="mt-6 text-center">
              ...
              {timer > 0 ? (
                ...
                <button
                  className="text-blue-400 font-medium text-sm hover:text-blue-300 disabled:opacity-50 cursor-pointer"
